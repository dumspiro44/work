...
const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    'select_posts': '2. Select Content to Translate',
    'select_posts_desc': 'Navigate to Content Management to view your WordPress content and select which ones to translate.',
    ...
    'start_translation': 'Start by selecting content to translate in Content Management.',
    ...
    'total_posts': 'Total Content',
    'total_posts_desc': 'WordPress Content',
  ...
  ru: {
    ...
    'select_posts': '2. Выберите контент для перевода',
    'select_posts_desc': 'Перейдите в раздел управления контентом, чтобы просмотреть ваш контент WordPress и выбрать то, что нужно перевести.',
    ...
    'total_posts': 'Всего контента',
    'total_posts_desc': 'Контент WordPress',
