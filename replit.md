...
7. **Translation Editor** - Бесплатный Froala с гарантией при публикации:
   ...
   - ✅ **Публикация в WordPress**:
     1. Исходный HTML из Froala отправляется **как есть** (никакие преобразования!)
   ...
   - ✅ **100% гарантия** для таблиц: отправляются как исходный HTML без преобразований
   - ✅ **Ссылки сохранены**: все `<a href="">` передаются из Froala как есть
