...
7. **Translation Editor** - ReactQuill для полной гарантии:
   - ✅ **ReactQuill редактор** - Полный toolbar: жирный, курсив, таблицы, ссылки, картинки, выравнивание
   - ✅ **Видимые ссылки** - Все ссылки виды в редакторе через кнопку "link"
   - ✅ **Редактирование** - Все правки сохраняются в БД
   - ✅ **Публикация в WordPress**:
     1. HTML из ReactQuill отправляется **как есть** (никакие преобразования!)
   ...
   - ✅ **ReactQuill парсит HTML** - гарантирует что таблицы остаются таблицами, не становятся текстом
