...
7. **Translation Editor** - Бесплатный Froala с гарантией:
   - ✅ **Froala редактор** - Полный toolbar: жирный, курсив, таблицы, ссылки, картинки, выравнивание
   - ✅ **Таблицы поддерживаются** - Встроенная кнопка "insertTable" с полной поддержкой
   - ✅ **Редактирование** - Все правки сохраняются в БД
   - ✅ **Высота расширяется** - Редактор растет по размеру контента (от 350px до 1200px)
   - ✅ **Публикация в WordPress**:
     1. HTML из Froala отправляется **как есть** (никакие преобразования!)
   ...
   - ✅ **100% гарантия** для таблиц и ссылок: отправляются как исходный HTML без преобразований
   - ⚠️ Ссылки могут не отображаться в редакторе (ограничение бесплатной версии) но гарантированно сохранены в HTML
   - Бесплатная версия Froala (без платной лицензии $199+/год)
